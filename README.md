...
4. Run the script. DGE result CSV files will be saved to a `results/` folder in the working directory. All visualisations will be rendered in RStudio's plot pane.
